...
_shorttext         = "Exile Sahrani By StruthMate Gaming";
_posText           = [0.8,0.5,0.4];


_title2         = "Website";
_shorttext2     = "www.struthmategaming.net";
_posText2        = [0.8,0.5,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "TS.STRUTHMATEGAMING.NET:9990";
...
_shorttext5     = "AI Missions<br />Custom Traders<br /> ";
...
_title7        = "Mods";
_shorttext7    = "Mas Weapons <br />Mas Vehicles<br />";
